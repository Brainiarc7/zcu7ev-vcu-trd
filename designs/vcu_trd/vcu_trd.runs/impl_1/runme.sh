...
HD_PWD='/home/brainiarc7/designs/vcu_trd/vcu_trd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vcu_trd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vcu_trd_wrapper.tcl -notrace
