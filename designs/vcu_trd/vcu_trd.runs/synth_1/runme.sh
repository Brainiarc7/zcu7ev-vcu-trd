...
HD_PWD='/home/brainiarc7/designs/vcu_trd/vcu_trd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vcu_trd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vcu_trd_wrapper.tcl
